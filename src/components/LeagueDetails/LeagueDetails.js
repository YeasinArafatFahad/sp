        ...
        <div className="row">
          <div className="col-8 py-2 offset-4">
            <a href={leagueDetails.strFacebook} target='_blank' rel='nooperer noreferrer'>
              <img className="rounded" style={{ width: "15%" }} src="/logo/Facebook.png" alt="Facebook img" />
            </a>
            <a href={leagueDetails.strTwitter}>
              <img className="rounded" style={{ width: "15%" }} src="/logo/Twitter.png" alt="Twitter img" />
            </a>
            <a href={leagueDetails.strYoutube}>
              <img className="rounded" style={{ width: "15%" }} src="/logo/Youtube.png" alt="Youtube img" />
            </a>
          </div>
        </div>
      </div>
